...
// const handleGetDistrictFromProvinceCode = computed(() => {
//   const data = getDistrictFromProvinceCode(areaLocal.value.province.code);
//   return data;
// });
watch(
...
<template>
    <Form @submit="submitProvinces" :validation-schema="areaFormSchema" id="provincesFormData">
        <div class="row">
            <div class="col-md-4 my-1" v-if="isLoading">
                <label for="province">Tỉnh/ Thành phố <span class="text-danger">*</span></label>
                <Field name="province" class="form-control my-1" v-model="areaLocal.province" placeholder="Chọn...">
                    <VueSelect v-model="areaLocal.province" :options="provinces" placeholder="Chọn tỉnh/thành phố.."
                        label="name" class="my-1" name="province"></VueSelect>
                </Field>
                <ErrorMessage name="province" class="animated fadeIn text-danger" />
            </div>
            <div class="col-md-4 my-1" v-if="districts != []">
                <label for="district">Quận/ Huyện <span class="text-danger">*</span></label>
                <Field name="district" class="form-control my-1" v-model="areaLocal.district" placeholder="Chọn...">
                    <VueSelect v-model="areaLocal.district" :options="districts" placeholder="Chọn quận/huyện.."
                        label="name" class="my-1" name="district"></VueSelect>
                </Field>
            ...
            <div class="col-md-4 my-1" v-if="wards != []">
                ...
                <Field name="ward" class="form-control my-1" v-model="areaLocal.ward" placeholder="Chọn...">
                    <VueSelect v-model="areaLocal.ward" :options="wards" placeholder="Chọn phường/xã.." label="name"
                        class="my-1" name="ward"></VueSelect>
                </Field>
